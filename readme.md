...
> Sistema de gerenciamento de tarefas via terminal, feito em Python.
> A terminal-based task management system, built with Python.
...
Feito por | Made by **Erick** — [GitHub](https://github.com/semendeZ0)